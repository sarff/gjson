...
func TestModKey2Obj(t *testing.T) {
	...
	`
	assert(t, Get(json, "tickets.@withKey.@values.#._key").String() == `["ISSUE-10","ISSUE-12","ISSUE-17"]`)
	assert(t, Get(json, "tickets.@withKey.@values.0").String() == `{"subject":"foo","priority":1,"id":123,"_key":"ISSUE-10"}`)
}
